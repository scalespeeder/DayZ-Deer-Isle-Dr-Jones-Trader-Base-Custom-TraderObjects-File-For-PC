DayZ Dr Jones Trader Mod Custom TraderObjects File To Spawn Trader Base At Main Airfield On Deer Isle For PC Servers Instructions & Terms Of Use
...
Limited Testing on PC Deer Isle Local Server DAYZ Version 1.20 May 2023.
...
Inside your servers config / profiles / settings folder (can had different names) find the Trader folder, and inside that replace the existing TraderObjects
